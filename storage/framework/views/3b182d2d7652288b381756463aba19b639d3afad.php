            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarAdvanceUI">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="" class="nav-link" data-key="t-sweet-alerts">Market</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link" data-key="t-nestable-list">Simpan Pinjam</a>
                        </li>
                    </ul>
                </div>
            </li>
...
<?php /**PATH D:\KULIAH\tugas kuliah\Semester 4\WEB(LARAVEL)\Project\kopdig-koperasi-edit\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>